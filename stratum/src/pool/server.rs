...
//    }
    ...
    // {"id":"GrinPool","jsonrpc":"2.0","method":"login","params":{"agent":"NBMiner/30.2","login":"","pass":""}}
    ...
    // {"id":"GrinPool","jsonrpc":"2.0","method":"getjobtemplate","params":null}
                        ...
                        match rpc_msg {
                            Some(message) => {
                                ...
                                if v["method"] == String::from("job") {
                                    ...
                                    // Request from upstream stratum server (job push)
                                    ...
                                    // Response from upstream stratum server (response of login/getjobtemplate/submit)
